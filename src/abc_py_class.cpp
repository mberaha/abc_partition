...
// template<>
// AbcPy<double, arma::vec, UnivGaussianKernel>::AbcPy(
//     std::vector<double> data, double theta, double sigma,
//     double eps0, std::string distance, int max_iter,
//     UnivGaussianKernel kernel, double entropic_eps, double threshold) : 
//       data(data), data_synt(data), n_data(data.size()), theta(theta),
...
//     d = new UniformSinkhorn<double>(entropic_eps, threshold, max_iter, false);
//   else if (distance == "greenkhorn")
//     d = new UniformSinkhorn<double>(entropic_eps, threshold, max_iter, true);
